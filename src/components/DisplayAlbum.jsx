    ...
    <>
      ...
      <div className="mt-10 flex gap-8 flex-col md:flex-row md-items-end">
        ...
        <div className="flex flex-col">
            ...
            <p className="mt-1">
                <img className="inline-block w-5 gap-6" src={assets.tonyfly_logo} alt="" />
                <b> StonyFly </b>
                · 1,323,154 likes
                · <b> 50 canciones, </b>
                about 2hr 30 min
      ...
      <div className="grid grid-cols-3 sm:grid-cols-4 mt-10 mb-4 pl-2 text-[#a7a7a7]">
        ...
        <p>Álbum</p>
        <p className="hidden sm:block">Fecha de Adición</p>
      ...
      <hr />
      {
        songsData.map((items,index)=>(
          <div onClick={() => playWithId(items.id)} key={index} className="grid grid-cols-3 sm:grid-cols-4 gap-2 p-2 items-center text-[#a7a7a7] hover:bg-[#ffffff2b] cursor-pointer ">
            ...
            <p className="text-[15px] hidden sm:block"> 5 dias antes</p>
