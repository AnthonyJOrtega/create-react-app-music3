    ...
    <>
      <div className="w-full flex justify-between items-center font-semibold">
        ...
        <div className="flex items-center gap-4">
             <p className="bg-green-500 text-black text-[15px] px-4 py-1 rounded-2xl hidden md:block cursor-pointer">Explorar Premium</p>
            <p className="bg-white text-black py-1 px-3 rounded-2xl text-[15px] cursor-pointer">Install App</p>
