...
const Player = () => {
    ...
    const { seekBg, seekBar, playStatus, play, pause, track, time, next, previous, seekSong, shuffle, loop, isLooping } = useContext(PlayerContext);
    ...
    <div className="h-[10%] bg-black flex justify-between items-center text-white px-4 ">
        ...
        <div className= "flex flex-col items-center gap-1 m-auto">
            <div className="flex gap-4">
                ...
                <img onClick = {loop} className="w-4 cursor-pointer" src={isLooping ? assets.loop_icon_actives : assets.loop_icon} alt="" />
            </div>
